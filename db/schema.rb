...
ActiveRecord::Schema.define(version: 20151228144816) do
  ...
  create_table "shops", force: :cascade do |t|
    ...
    t.string  "shop_refid",       limit: 255
    t.integer "location_distant", limit: 4
    t.integer "coupon",           limit: 4
  end

  add_index "shops", ["shop_refid"], name: "index_shops_on_shop_refid", using: :btree
