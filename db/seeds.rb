...
Shop.create(shop_location:"을지로입구역", shop_name:"매머드커피", cafe_phone:"02-720-3007",cafe_img:"http://bringit.kr/img/cafe_img/mmth19.png" , shop_refid:"mmth19",coupon:12,location_distant:100,shop_loginid:"test")
